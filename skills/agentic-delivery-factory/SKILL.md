...
| Factory Template / Stack Adapter composition / policy composer | `references/schemas/factory-template-composition-contract.md`, `references/schemas/delivery-profile-matrix.md`, `references/schemas/policy-composer.md` |
